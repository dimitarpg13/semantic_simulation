...
(§4–5, §10),
[Blended CfC BAOAB Deep Dive](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md)
(§3–5, §10),
[Modified BAOAB with STP Identity](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Modified_BAOAB_with_STP_identity_Detailed_Analysis.md)
(§1.2, §3).

> **Rendering note.** This document uses GitHub-native `$...$` / `$$...$$`
> math and fenced `mermaid` blocks. Figures live in
> [`docs/images/`](../images/) and are generated by
...
([Blended CfC, §5.4](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md))
and a textbook **BAOAB** sequence with two B-kicks
([Blended CfC, §3](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md);
[Modified BAOAB, §1.2](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Modified_BAOAB_with_STP_identity_Detailed_Analysis.md)).
...
([Closed-Form Strategies, §5](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Closed_Form_and_Hybrid_Integration_Strategies_for_Fock-PARFLM.md);
...
[Closed-Form Strategies, §2](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Closed_Form_and_Hybrid_Integration_Strategies_for_Fock-PARFLM.md):
...
[Closed-Form Strategies, §4–5](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Closed_Form_and_Hybrid_Integration_Strategies_for_Fock-PARFLM.md).
...
([Closed-Form Strategies, §5.2 and the free-particle limit in §5](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Closed_Form_and_Hybrid_Integration_Strategies_for_Fock-PARFLM.md);
[Blended CfC, §5.2](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md)).
...
([Blended CfC, §5.1, properties of $\Phi_k$](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md)).
...
[Modified BAOAB, §1.2](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Modified_BAOAB_with_STP_identity_Detailed_Analysis.md)
and [Blended CfC, §3](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md)
...
[Blended CfC, §2.1 and §5.1](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md)
...
- `create_graph=True` in training records a graph **on the
  ...
  and the in-repo [autograd deep dive](../pytorch/autograd_deep_dive.md).
...
1. [Closed-Form and Hybrid Integration Strategies for Fock-PARFLM](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Closed_Form_and_Hybrid_Integration_Strategies_for_Fock-PARFLM.md)
...
2. [Deep Dive: The Blended CfC BAOAB Integrator](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Blended_CfC_BAOAB_Deep_Dive.md)
   ...
   only in O).
3. [Modified BAOAB with STP Identity](https://github.com/dimitarpg13/semsimula-paper/blob/main/companion_notes/Modified_BAOAB_with_STP_identity_Detailed_Analysis.md)
...
4. [BAOAB Deep Dive](BAOAB_Deep_Dive.md) (this folder) — operator
   splitting, Trotter / Strang, why ordering matters, the
   BAOAB-versus-ABOBA zoo.
...
19. In-repo: [A Deep Dive into PyTorch's Autograd Computation Graph](../pytorch/autograd_deep_dive.md).
